...
export const ProjectCard = ({ projects }: ProjectCardProps) => {
  ...
  return (
    <>
      ...
      >
        <div className='group flex flex-grow flex-row gap-4 rounded-lg border-[1px] p-4 backdrop-blur-sm transition-colors hover:border-2 hover:border-neutral-300 hover:bg-gray-100 dark:border-neutral-500 hover:dark:border-neutral-100 hover:dark:bg-neutral-800/30'>
          <Image
